Feature: Profile Management
  ...
  Background:
    Given the following users exist:
      | email                      | name        | college            | hostel        |
      | 1155000123@link.cuhk.edu.hk | Test User   | Chung Chi College  | Lee Shu Pui Hall |
  ...
  Scenario: Successfully update profile text information
    ...
    And my profile should display "New Name"
    And my profile should display "This is my new bio."
  ...
  Scenario: Prevent saving without a college
    ...
    And I click the "Save" button
    Then I should see "Please select your College before saving."
